...
namespace Abc.Pages.Extensions
{
    public static class DetailsTableForHtmlExtension {
        ...
        internal static IList<object> createString<TModel, TResult>(IHtmlHelper<TModel> htmlHelper, Expression<Func<TModel, IList<TResult>>> expression, Expression<Func<TResult, object>>[] properties)
        {
