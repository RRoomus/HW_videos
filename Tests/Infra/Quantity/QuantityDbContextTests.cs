...
namespace Abc.Tests.Infra.Quantity
{
    ...
    [TestClass] public class QuantityDbContextTests : BaseClassTests<QuantityDbContext, DbContext>
    {
        ...
        [TestMethod]
        public void MeasuresTest() => IsNullableProperty(obj, nameof(obj.Measures), typeof(DbSet<MeasureData>));
        ...
        [TestMethod]
        public void UnitTermsTest() => IsNullableProperty(obj, nameof(obj.UnitTerms), typeof(DbSet<UnitTermData>));

        [TestMethod]
        public void MeasureTermsTest() => IsNullableProperty(obj, nameof(obj.MeasureTerms), typeof(DbSet<MeasureTermData>));
    }
